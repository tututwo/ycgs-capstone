...
**Architecture:** Keep `analysis/initial_EDA.qmd` as the primary executable analysis. Move raw data, metadata, reports, documentation, scripts, communication products, and archived scratch work into clearly named top-level folders.
...
**Files:**
- Move: `EDA/initial_EDA.qmd` to `analysis/initial_EDA.qmd`
- Move: `EDA/initial_EDA.pdf` to `reports/initial_EDA.pdf`
...
**Files:**
- Modify: `analysis/initial_EDA.qmd`
